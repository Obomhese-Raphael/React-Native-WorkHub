...
export default function SignUpScreen() {
  ...
  const handleEmailSignUp = async () => {
    if (!firstName || !lastName || !email || !password) {
      return Alert.alert(
        "Required",
        "All identification fields must be populated."
      );
    }
    setLoading(true);
    try {
      ...
      Alert.alert(
        "System Error",
        err.errors?.[0]?.message || "Failed to initialize identity"
      );
    } finally {
      setLoading(false);
    }
          ...
          >
            ...
            <View className="mb-10">
              ...
              <Text className="text-slate-400 mt-2 font-medium">
                {pendingVerification
                  ? `Sequence sent to ${email}`
                  : "Initialize your workspace credentials."}
              </Text>
            </View>
            ...
            {pendingVerification ? (
              ...
              <View>
                ...
                <TouchableOpacity
                  ...
                  className="mt-6 bg-blue-600 py-5 rounded-2xl"
                >
              ...
              <View>
                ...
                <TouchableOpacity
                  ...
                  className="w-full bg-slate-800/30 border mt-5 border-slate-700/50 rounded-2xl py-5 flex-row justify-center items-center"
                >
                  {googleLoading ? (
